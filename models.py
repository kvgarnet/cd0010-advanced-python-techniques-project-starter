...
class NearEarthObject:
    ...
    def __init__(self, designation, name, diameter=float("nan"), pha=False, **info):
        """Create a new `NearEarthObject`.
        :param designation:
            The primary designation for this NearEarthObject(NEO).
            This is a unique identifier in the database, and its "name" to computer systems.
        :pram name:
            International Astronomical Union (IAU) name of the NEO.
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject(NEO) {self.fullname} has a diameter of {self.diameter:.3f} km, " \
    ...
    def serialize(self):
        """Serialize the NEO's data for CSV or JSON serialization when writing to file
...
class CloseApproach:
    ...
    def serialize(self):
        """Serialize the Close approaches' data for CSV or JSON serialization when writing to file.
